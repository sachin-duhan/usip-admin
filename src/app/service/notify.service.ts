...
export class NotifyService {
    ...
    publicNotification(): Observable<any> {
        return this.http.get<any>(this._urlNotify + '/public', { headers: this.headers });
    }

    internNotification(): Observable<any> {
        return this.http.get<any>(this._urlNotify + '/intern', { headers: this.headers });
    }

    postNotification(data): Observable<any> {
        return this.http.post<any>(this._urlNotify, data, {headers: this.headers});
    }
